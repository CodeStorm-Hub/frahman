...
- Name: 07-ledger.spec.ts >> Ledger / double-entry accounting >> ledger page loads and shows journal entries
- Location: e2e\07-ledger.spec.ts:13:3
...
Locator: getByRole('heading', { name: /ledger|journal/i })
Expected: visible
Timeout: 8000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: /ledger|journal/i })
