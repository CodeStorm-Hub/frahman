...
- Name: 04-retailers.spec.ts >> Retailers >> retailer detail page shows zero balance for new retailer
- Location: e2e\04-retailers.spec.ts:53:3
...
Call log:
  - waiting for getByRole('link').filter({ hasText: 'Karim Traders E2E 1782143018268' }).first()
