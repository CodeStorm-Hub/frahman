...
- Name: 05-sales.spec.ts >> Sales invoicing >> sales page loads with invoice table
- Location: e2e\05-sales.spec.ts:16:3
...
Locator: getByRole('heading', { name: /invoices/i })
Expected: visible
Timeout: 8000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: /invoices/i })
