...
- Name: 02-dashboard.spec.ts >> Dashboard >> sidebar navigation links are all present
- Location: e2e\02-dashboard.spec.ts:21:3
...
Locator: locator('nav').getByRole('link', { name: /dashboard/i })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('nav').getByRole('link', { name: /dashboard/i })
