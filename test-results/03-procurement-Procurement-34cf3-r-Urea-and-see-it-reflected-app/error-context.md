...
- Name: 03-procurement.spec.ts >> Procurement intake >> add inventory batch for Urea and see it reflected
- Location: e2e\03-procurement.spec.ts:20:3
...
Locator: getByRole('button', { name: /add batch|receive stock|intake/i })
Expected: visible
Timeout: 8000ms
...
Call log:
  ...
  - waiting for getByRole('button', { name: /add batch|receive stock|intake/i })
