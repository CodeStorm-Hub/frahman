...
- Name: 05-sales.spec.ts >> Sales invoicing >> invoice list date-range filter works
- Location: e2e\05-sales.spec.ts:53:3
...
Locator: getByLabel(/from date/i)
Expected: visible
Timeout: 8000ms
...
Call log:
  ...
  - waiting for getByLabel(/from date/i)
