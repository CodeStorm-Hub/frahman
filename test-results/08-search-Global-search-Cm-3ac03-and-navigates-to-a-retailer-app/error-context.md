...
- Name: 08-search.spec.ts >> Global search (Cmd+K palette) >> search palette filters and navigates to a retailer
- Location: e2e\08-search.spec.ts:25:3
...
Locator: locator('[cmdk-root], [role=\'dialog\']').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('[cmdk-root], [role=\'dialog\']').first()
