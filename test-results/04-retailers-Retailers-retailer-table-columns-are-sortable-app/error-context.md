...
- Name: 04-retailers.spec.ts >> Retailers >> retailer table columns are sortable
- Location: e2e\04-retailers.spec.ts:79:3
...
Locator: getByRole('columnheader', { name: /shop/i })
Expected: visible
Timeout: 8000ms
...
Call log:
  ...
  - waiting for getByRole('columnheader', { name: /shop/i })
