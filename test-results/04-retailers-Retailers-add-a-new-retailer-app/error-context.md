...
- Name: 04-retailers.spec.ts >> Retailers >> add a new retailer
- Location: e2e\04-retailers.spec.ts:24:3
...
Locator: getByRole('button', { name: /add retailer|new retailer/i })
Expected: visible
Timeout: 8000ms
...
Call log:
  ...
  - waiting for getByRole('button', { name: /add retailer|new retailer/i })
