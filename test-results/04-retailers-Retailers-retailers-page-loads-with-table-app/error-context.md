...
- Name: 04-retailers.spec.ts >> Retailers >> retailers page loads with table
- Location: e2e\04-retailers.spec.ts:17:3
...
Locator: getByRole('heading', { name: /retailers/i })
Expected: visible
Timeout: 8000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: /retailers/i })
